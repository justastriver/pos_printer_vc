...
BOOL PrintInStandardMode80(void)
{
	...
	VC_POS_S_TextOut("佳博热敏打印机", 20, 1, 1, POS_FONT_TYPE_CHINESE,
		POS_FONT_STYLE_THICK_UNDERLINE);
	VC_POS_FeedLine();
	VC_POS_S_TextOut("佳 博 热 敏 打 印 机", 20, 1, 1, POS_FONT_TYPE_CHINESE,
	...
	VC_POS_SetRightSpacing(0);
	VC_POS_S_TextOut("GP58", 20, 1, 1, POS_FONT_TYPE_STANDARD, 
		POS_FONT_STYLE_NORMAL);
	...
	VC_POS_S_TextOut("GP58P", 20, 1, 1, POS_FONT_TYPE_STANDARD,
		POS_FONT_STYLE_NORMAL);
	VC_POS_S_TextOut("POS Thermal Printer", 200, 1, 1, POS_FONT_TYPE_STANDARD,
		POS_FONT_STYLE_NORMAL);
	VC_POS_FeedLine();
...
BOOL PrintInPageMode80(void)
{
	...
	VC_POS_SetRightSpacing(0);
	VC_POS_PL_TextOut("GP58", 30, 140, 1, 1, POS_FONT_TYPE_STANDARD,
		POS_FONT_STYLE_NORMAL);
	VC_POS_PL_TextOut("POS Thermal Printer", 300, 140, 1, 1, POS_FONT_TYPE_STANDARD,
		POS_FONT_STYLE_NORMAL);

	VC_POS_SetRightSpacing(4);
	VC_POS_PL_TextOut("GP58", 30, 180, 1, 1, POS_FONT_TYPE_STANDARD,
		POS_FONT_STYLE_NORMAL);
	VC_POS_PL_TextOut("POS Thermal Printer", 300, 180, 1, 1, POS_FONT_TYPE_STANDARD,
		POS_FONT_STYLE_NORMAL);

	VC_POS_SetRightSpacing(8);
	VC_POS_PL_TextOut("GP58", 30, 220, 1, 1, POS_FONT_TYPE_STANDARD,
		POS_FONT_STYLE_NORMAL);
...
BOOL PrintInPageMode56(void)
{
	...
	VC_POS_SetRightSpacing(0);
	VC_POS_PL_TextOut("GP58", 5, 80, 1, 1, POS_FONT_TYPE_STANDARD,
		POS_FONT_STYLE_NORMAL);
	...
	VC_POS_SetRightSpacing(4);
	VC_POS_PL_TextOut("GP58", 5, 110, 1, 1, POS_FONT_TYPE_STANDARD,
		POS_FONT_STYLE_NORMAL);
	VC_POS_PL_TextOut("POS Thermal Printer", 230, 110, 1, 1, POS_FONT_TYPE_STANDARD,
		POS_FONT_STYLE_NORMAL);

	VC_POS_SetRightSpacing(8);
	VC_POS_PL_TextOut("GP58P", 5, 140, 1, 1, POS_FONT_TYPE_STANDARD,
		POS_FONT_STYLE_NORMAL);
